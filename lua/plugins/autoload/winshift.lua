return {
  ...
  keys = {
    ...
    { '<leader>wK', '<cmd>WinShift far_up<cr>'   , desc = 'Move [w]indow far up' },
    { '<leader>wJ', '<cmd>WinShift far_down<cr>' , desc = 'Move [w]indow far down' },
    { '<leader>wH', '<cmd>WinShift far_left<cr>' , desc = 'Move [w]indow far left' },
    { '<leader>wL', '<cmd>WinShift far_right<cr>', desc = 'Move [w]indow far right' },
  }
}
